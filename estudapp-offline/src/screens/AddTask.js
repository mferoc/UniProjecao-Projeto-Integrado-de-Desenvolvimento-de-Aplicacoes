...
export default class AddTask extends Component {
    ...
    constructor(props) {
        super(props)
        this.state = props.selectedTask ? props.selectedTask : initialState
    ...
    handleDateTimeAndroidChanged = () => {
        const momentDateTime = moment(this.state.time)
        TimePickerAndroid.open({
            ...
            if (f.action !== TimePickerAndroid.dismissedAction) {
                ...
                this.setState({ date: momentDateTime.toDate() })
            }
        })
            ...
            datePicker = (
                <TouchableOpacity onPress={this.handleDateTimeAndroidChanged}>
                    <Text style={styles.date}>
                        {moment(props.date).format('ddd, D [de] MMMM [de] YYYY [às] LT')}
                    </Text>
                </TouchableOpacity>
            )
        }
