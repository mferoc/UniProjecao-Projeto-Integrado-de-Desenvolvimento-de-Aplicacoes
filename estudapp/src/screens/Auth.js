...
export default class Auth extends Component {
	...
	signin = async () => {
		try {
			...
			Alert.alert('Ops! Erro!', 'Impossível efetuar Login')
			//showError(err)
		}
	}
	...
	signup = async () => {
		try {
			...
			Alert.alert('Oba! Sucesso!', 'Usuário cadastrado!')
			...
			<ImageBackground source={backgroundImage}
				...
				<View style={styles.formContainer}>
					<Text style={styles.subtitle}>
						{this.state.stageNew ?
							'Crie a sua conta:' : 'Informe os dados cadastrados:'}
					</Text>
					{this.state.stageNew &&
						<AuthInput icon='user'
							placeholder='Nome'
					...
					{this.state.stageNew &&
						<AuthInput icon='asterisk'
							secureTextEntry={true}
							placeholder='Confirme sua senha' style={styles.input}
